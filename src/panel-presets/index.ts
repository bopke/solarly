...
export interface PanelPreset {
  ...
  /**
   * Approximate module area, in square meters. Used as an internal
   * cross-check (`ratedWattsPeak ≈ efficiencyPercent/100 × areaM2 × 1000`)
   * to catch model-code/spec mismatches; not otherwise load-bearing.
   */
  areaM2: number
  /**
 ...
 *   - LONGi Hi-MO 6 series datasheets (longi.com)
